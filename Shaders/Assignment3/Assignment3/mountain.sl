...
surface mountain (float Ka = 0, Kd = 1; float dist = 1400;	float grassFreq = 2; float waterLevel = 9;)
{
	...
	lakeSel = smoothstep(0.9, 0.935, lakeSel);
	//SEACOLOR END
	...
	//följa för att inte vattnet ska vara svart/blått, ger en vit effekt på vågorna från fBm	
	outCol = (mix(outCol,lakeBlue * (1-waves ),lakeSel) 
		+ mix(outCol,(1.0,1.0,1.0) * waves ,lakeSel))/2;
